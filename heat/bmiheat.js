...
class BmiHeat extends Bmi{
     ...
     * @method initialize
     * @param {string} - Path to name of input file.
     */
     ...
     * Advance model by one time step.
     * @method update_frac
     * @param {number} time_frac- Fraction fo a time step.
     */
     ...
     * @method update_until
     * @param {number} then- Time to run model until.
     */
    update_until(then){ 
    ...
    get_var_nbytes(var_name){
        ...
        throw "NotImplementedError get_var_nbytes"
    }       
        
    get_var_grid(var_name){

        throw "NotImplementedError get_var_grid"
